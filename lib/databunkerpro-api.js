...
var DatabunkerproAPI = /** @class */ (function () {
    ...
    DatabunkerproAPI.prototype.createToken = function (tokentype_1, record_1) {
        return __awaiter(this, arguments, void 0, function (tokentype, record, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
    ...
    DatabunkerproAPI.prototype.createTokensBulk = function (records_1) {
        return __awaiter(this, arguments, void 0, function (records, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('TokenCreateBulk', 'POST', { records: records }, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.listTokensBulk = function (tokens_1) {
        return __awaiter(this, arguments, void 0, function (tokens, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('TokenListBulk', 'POST', { tokens: tokens }, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.deleteTokensBulk = function (tokens_1) {
        return __awaiter(this, arguments, void 0, function (tokens, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('TokenDeleteBulk', 'POST', { tokens: tokens }, requestMetadata)];
            });
        });
    };
    // Audit Management
    ...
    DatabunkerproAPI.prototype.upsertSession = function (sessionuuid_1, data_1) {
        return __awaiter(this, arguments, void 0, function (sessionuuid, data, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('SessionUpsert', 'POST', __assign({ sessionuuid: sessionuuid }, data), requestMetadata)];
            });
        });
    };
