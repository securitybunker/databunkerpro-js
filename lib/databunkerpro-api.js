...
var DatabunkerproAPI = /** @class */ (function () {
    ...
    DatabunkerproAPI.prototype.createConnector = function (connectorname_1, connectortype_1, apikey_1) {
        return __awaiter(this, arguments, void 0, function (connectorname, connectortype, apikey, options, requestMetadata) {
            var data;
            if (options === void 0) { options = {}; }
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = __assign({ connectorname: connectorname, connectortype: connectortype, apikey: apikey }, options);
                return [2 /*return*/, this.makeRequest('ConnectorsCreateConnector', 'POST', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.updateConnector = function (connectorid_1, connectorname_1, connectortype_1, apikey_1) {
        return __awaiter(this, arguments, void 0, function (connectorid, connectorname, connectortype, apikey, options, requestMetadata) {
            var data;
            if (options === void 0) { options = {}; }
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = __assign({ connectorid: connectorid, connectorname: connectorname, connectortype: connectortype, apikey: apikey }, options);
    ...
    DatabunkerproAPI.prototype.validateConnectorConnectivity = function () {
        return __awaiter(this, arguments, void 0, function (options, requestMetadata) {
            ...
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('ConnectorsValidateConnectivity', 'POST', options, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.connectorsGetTableMetadata = function (connectorid_1, apikey_1, username_1, connectortype_1, dbhost_1, dbname_1, tablename_1) {
        return __awaiter(this, arguments, void 0, function (connectorid, apikey, username, connectortype, dbhost, dbname, tablename, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = {
