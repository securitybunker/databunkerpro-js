...
var DatabunkerproAPI = /** @class */ (function () {
    ...
    DatabunkerproAPI.prototype.renameTenant = function (tenantid_1, tenantname_1) {
    ...
    DatabunkerproAPI.prototype.cancelUserRequest = function (mode_1, identity_1, requestuuid_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, requestuuid, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
    ...
    DatabunkerproAPI.prototype.approveUserRequest = function (mode_1, identity_1, requestuuid_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, requestuuid, requestMetadata, reason) {
            if (requestMetadata === void 0) { requestMetadata = null; }
