...
var DatabunkerproAPI = /** @class */ (function () {
    ...
    DatabunkerproAPI.prototype.createTokensBulk = function (records_1) {
        return __awaiter(this, arguments, void 0, function (records, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('TokenCreateBulk', 'POST', { data: records }, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.listTokensBulk = function (options_1) {
        return __awaiter(this, arguments, void 0, function (options, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('TokenListBulk', 'POST', options, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.deleteTokensBulk = function (tokens_1) {
        return __awaiter(this, arguments, void 0, function (tokens, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('TokenDeleteBulk', 'POST', { data: tokens }, requestMetadata)];
            });
        });
    };
    // Audit Management
