...
var DatabunkerproAPI = /** @class */ (function () {
    ...
    DatabunkerproAPI.prototype.getUser = function (mode_1, identity_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, version, requestMetadata) {
            var data;
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest('UserGet', data, requestMetadata)];
            });
        });
    };
     ...
     * ]);
     */
    DatabunkerproAPI.prototype.deleteUsersBulk = function (users_1) {
        return __awaiter(this, arguments, void 0, function (users, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { users: users };
                return [2 /*return*/, this.makeRequest('UserDeleteBulk', data, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.searchUser = function (identity_1, unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (identity, unlockuuid, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { identity: identity, unlockuuid: unlockuuid };
                return [2 /*return*/, this.makeRequest('UserSearch', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.listUserVersions = function (mode_1, identity_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { mode: mode, identity: identity };
                return [2 /*return*/, this.makeRequest('UserListVersions', data, requestMetadata)];
            });
        });
    };
    // User Authentication
    ...
    DatabunkerproAPI.prototype.deleteAppData = function (mode_1, identity_1, appname_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, appname, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { mode: mode, identity: identity, appname: appname };
                return [2 /*return*/, this.makeRequest('AppdataDelete', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.listAppDataVersions = function (mode_1, identity_1, appname_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, appname, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { mode: mode, identity: identity, appname: appname };
                return [2 /*return*/, this.makeRequest('AppdataListVersions', data, requestMetadata)];
            });
        });
    };
     ...
     */
    DatabunkerproAPI.prototype.createFile = function (mode_1, identity_1, filename_1, filedata_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, filename, filedata, options, requestMetadata) {
            var data, _i, _a, key;
            if (options === void 0) { options = {}; }
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_b) {
                data = { mode: mode, identity: identity, filename: filename, filedata: filedata };
                for (_i = 0, _a = ['mimetype', 'tags', 'slidingtime', 'finaltime']; _i < _a.length; _i++) {
                    key = _a[_i];
                    if (options[key] !== undefined) {
                        data[key] = options[key];
                    }
                }
                return [2 /*return*/, this.makeRequest('FileCreate', data, requestMetadata)];
            });
        });
    };
    /**
     ...
     */
    DatabunkerproAPI.prototype.getFile = function (mode_1, identity_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, options, requestMetadata) {
            var data, _i, _a, key;
            if (options === void 0) { options = {}; }
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_b) {
                data = { mode: mode, identity: identity };
                for (_i = 0, _a = ['fileuuid', 'filename', 'raw']; _i < _a.length; _i++) {
                    key = _a[_i];
                    if (options[key] !== undefined) {
                        data[key] = options[key];
                    }
                }
                return [2 /*return*/, this.makeRequest('FileGet', data, requestMetadata)];
            });
        });
    };
    /**
     ...
     */
    DatabunkerproAPI.prototype.downloadFile = function (mode_1, identity_1, fileuuid_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, fileuuid, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { mode: mode, identity: identity, fileuuid: fileuuid, raw: true };
                return [2 /*return*/, this.rawRequest('FileGet', data, requestMetadata)];
            });
        });
    };
    /**
     ...
     */
    DatabunkerproAPI.prototype.listUserFiles = function (mode_1, identity_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, tag, requestMetadata) {
            var data;
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest('FileListUserFiles', data, requestMetadata)];
            });
        });
    };
    /**
     ...
     */
    DatabunkerproAPI.prototype.replaceFileTags = function (mode_1, identity_1, fileuuid_1, tags_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, fileuuid, tags, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { mode: mode, identity: identity, fileuuid: fileuuid, tags: tags };
                return [2 /*return*/, this.makeRequest('FileReplaceTags', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.deleteFile = function (mode_1, identity_1, fileuuid_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, fileuuid, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { mode: mode, identity: identity, fileuuid: fileuuid };
                return [2 /*return*/, this.makeRequest('FileDelete', data, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.bulkListUsers = function (unlockuuid_1, users_1) {
        return __awaiter(this, arguments, void 0, function (unlockuuid, users, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { unlockuuid: unlockuuid, users: users };
                return [2 /*return*/, this.makeRequest('BulkListUsers', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.bulkListAllUsers = function (unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (unlockuuid, offset, limit, requestMetadata) {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest('BulkListAllUsers', data, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.bulkListAllUserRequests = function (unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (unlockuuid, offset, limit, requestMetadata) {
            var data;
            if (offset === void 0) { offset = 0; }
            if (limit === void 0) { limit = 10; }
            ...
            return __generator(this, function (_a) {
                data = { unlockuuid: unlockuuid, offset: offset, limit: limit };
                return [2 /*return*/, this.makeRequest('BulkListAllUserRequests', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.bulkListAllAuditEvents = function (unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (unlockuuid, offset, limit, requestMetadata) {
            var data;
            if (offset === void 0) { offset = 0; }
            if (limit === void 0) { limit = 10; }
            ...
            return __generator(this, function (_a) {
                data = { unlockuuid: unlockuuid, offset: offset, limit: limit };
                return [2 /*return*/, this.makeRequest('BulkListAllAuditEvents', data, requestMetadata)];
            });
        });
    };
    /**
     ...
     */
    DatabunkerproAPI.prototype.bulkListFilesByTag = function (unlockuuid_1, tag_1) {
        return __awaiter(this, arguments, void 0, function (unlockuuid, tag, offset, limit, requestMetadata) {
            var data;
            if (offset === void 0) { offset = 0; }
            if (limit === void 0) { limit = 10; }
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest('BulkListFilesByTag', data, requestMetadata)];
            });
        });
    };
    ...
    DatabunkerproAPI.prototype.getUserProfiles = function (mode_1, identity_1, unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, unlockuuid, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('SystemGetUserProfiles', { mode: mode, identity: identity, unlockuuid: unlockuuid }, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.searchUserProfiles = function (identity_1, unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (identity, unlockuuid, requestMetadata) {
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                return [2 /*return*/, this.makeRequest('SystemSearchUserProfiles', { identity: identity, unlockuuid: unlockuuid }, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.deleteUserProfiles = function (mode_1, identity_1, unlockuuid_1) {
        return __awaiter(this, arguments, void 0, function (mode, identity, unlockuuid, tenantref, requestMetadata) {
            var data;
            if (tenantref === void 0) { tenantref = null; }
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest('SystemDeleteUserProfiles', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.restoreUserProfile = function (token_1, unlockuuid_1, tenantref_1) {
        return __awaiter(this, arguments, void 0, function (token, unlockuuid, tenantref, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.makeRequest('SystemRestoreUserProfile', data, requestMetadata)];
            });
        });
    };
     ...
     * }
     */
    DatabunkerproAPI.prototype.generateWrappingKey = function (key1_1, key2_1, key3_1) {
        return __awaiter(this, arguments, void 0, function (key1, key2, key3, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { key1: key1, key2: key2, key3: key3 };
                return [2 /*return*/, this.makeRequest('SystemGenerateWrappingKey', data, requestMetadata)];
            });
        });
    };
    DatabunkerproAPI.prototype.setLicenseKey = function (licensekey_1) {
        return __awaiter(this, arguments, void 0, function (licensekey, requestMetadata) {
            var data;
            if (requestMetadata === void 0) { requestMetadata = null; }
            return __generator(this, function (_a) {
                data = { licensekey: licensekey };
                return [2 /*return*/, this.makeRequest('SystemSetLicenseKey', data, requestMetadata)];
            });
        });
    };
